    ...
    <section id='team' class='lp-section' style='background: var(--card-bg);'>
        ...
        <div class='grid-3'>
            <div class='lp-card' style='text-align: center; padding: 3rem 2rem;'>
                ...
                <div class='card-title'>Shayan Rizwan</div><div class='card-desc'>Backend Engineering</div>
            </div>
            <div class='lp-card' style='text-align: center; padding: 3rem 2rem;'>
                ...
                <div class='card-title'>Agha Salaat</div><div class='card-desc'>Database Design</div>
            </div>
            <div class='lp-card' style='text-align: center; padding: 3rem 2rem;'>
                ...
                <div class='card-title'>Anzar Mubashir</div><div class='card-desc'>Frontend Infrastructure</div>
            </div>
        </div>
    </section>
...
def login_screen():
    ...
    with st.sidebar:
        st.button("ToggleTheme", key="hidden_theme_btn", on_click=toggle_theme)
    ...
    components.html("""
        ...
        window.parent.toggleTheme = function() {
            ...
            for (let i = 0; i < buttons.length; i++) {
                if (buttons[i].innerText.includes('ToggleTheme')) {
                    buttons[i].click();
                    break;
                }
            }
...
if not st.session_state.user:
    ...
    header_cols = st.columns([9, 1.5], gap="small", vertical_alignment="center")
    with header_cols[1]:
        c_theme, c_logout = st.columns([1, 2.5])
        with c_theme:
            ...
            st.button(toggle_icon, use_container_width=True, key="auth_toggle", on_click=toggle_theme)
