...
/* Push the Streamlit content down to clear the fixed navbar */
.block-container {{ 
...
.nav-cta {{ 
    display: inline-flex; align-items: center; background: var(--card-bg); border: 1px solid var(--border-heavy); color: var(--text-main); 
    text-decoration: none; padding: 0.5rem 1.4rem; border-radius: 100px; font-size: 0.85rem; font-weight: 700; transition: all 0.3s ease; white-space: nowrap;
}}
...
/* ── AUTH PORTAL ── */
[data-testid="stForm"] {{
    background: var(--card-bg) !important; backdrop-filter: blur(20px) !important; -webkit-backdrop-filter: blur(20px) !important;
    border: 1px solid var(--border-heavy) !important; border-radius: 20px !important; padding: 3.5rem 3rem !important;
    box-shadow: 0 25px 50px -12px rgba(0,0,0,0.3) !important; position: relative !important; overflow: hidden !important;
}}
...
[data-testid="stFormSubmitButton"] > button {{ 
    border-radius: 8px !important; background: var(--btn-bg) !important; border: none !important; 
    padding: 0.8rem !important; margin-top: 1.5rem !important; transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1) !important; 
